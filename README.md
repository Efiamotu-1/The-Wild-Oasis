...
**[The Wild Oasis]** is an application built for a hotel management to be handled internally by staffs for booking and registering clients into their hotel, it has a beautiful dashboard and shows details about the available cabins as well as updated details on new arrivals.
...
```sh
  cd my-folder
  git clone https://github.com/Efiamotu-1/The-Wild-Oasis.git
```
...
Feel free to check the [issues page](https://github.com/Efiamotu-1/The-Wild-Oasis/issues).
